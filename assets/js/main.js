...
document.addEventListener('click', function (e) {
  ...
  if (t) { t.classList.remove('bi-x'); t.classList.add('bi-list'); }
});
...
if (searchInput) {
  searchInput.addEventListener("keyup", function () {
    ...
    let cards = document.querySelectorAll("#featured-tours .tour-card");
...
document.addEventListener("DOMContentLoaded", () => {
  ...
  if (lang === "en") {
    document.getElementById("partners").textContent = "Our partners"
    document.getElementById("partners-description").textContent = "Visit our partners' websites"
